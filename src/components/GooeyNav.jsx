...
const GooeyNav = ({
  ...
  const makeParticles = element => {
    ...
    for (let i = 0; i < particleCount; i++) {
      ...
      setTimeout(() => {
        ...
        // We use CSS variables defined in the style block below for colors 
  ...
  useEffect(() => {
    ...
    // Observing container for resizing
    ...
    <>
      ...
      */}
      <style>
        {`
          :root {
            --color-1: #38bdf8; /* sky-400 */
            --color-2: #fb7185; /* rose-400 */
            --color-3: #a78bfa; /* violet-400 */
            --color-4: #facc15; /* yellow-400 */
          ...
          .effect {
            ...
            place-items: center;
            z-index: 1;
            transition: all 0.3s cubic-bezier(0.55, 0, 1, 0.45); /* Smooth position transitions */
          }
          .effect.text {
            color: white;
            transition: color 0.3s ease;
            font-weight: 600; /* Added bolding for better visibility */
          ...
          .effect.filter::before {
            ...
            inset: -75px;
            z-index: -2;
            background: #111827; /* Tailwind gray-900 equivalent */
          }
          .effect.filter::after {
            content: "";
            position: absolute;
        ...
        <nav className="flex relative" style={{ transform: 'translate3d(0,0,0.01px)' }}>
          ...
          >
            {items.map((item, index) => (
              <li
                key={index}
                className={`nav-item-li rounded-full relative cursor-pointer font-semibold ${
