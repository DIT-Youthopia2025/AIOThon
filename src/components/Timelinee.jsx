...
export default function Timelinee() {
  return (
    ...
    >
      ...
      {/* Timeline Line */}
      <div className="relative rotate-90 sm:rotate-0 w-11/12 md:w-3/4 h-1 mt-9 bg-cyan-400">
        ...
        <div className="absolute left-[5%] top-[-172px] flex flex-col items-center">
          ...
          <div className="text-xs mt-2 text-white-300">NOVEMBER 7,2025</div>
        </div>

        {/* Event 2 */}
        <div className="absolute left-[30%] top-[-28px] flex flex-col items-center">
          <div className="text-xs mt-1 text-white-300">NOVEMBER 19,2025</div>
        ...
        <div className="absolute left-[55%] top-[-188px] flex flex-col items-center">
          ...
          <div className="w-0 h-30 border-dashed border-l-2 border-white"></div>
          <div className="w-2.5 h-2.5 bg-white rounded-full border-2 border-white -mt-[2px]"></div>
          <div className="text-xs mt-2 text-white-300">NOVEMBER 20-21,2025</div>
        </div>

        {/* Event 4 */}
        <div className="absolute left-[75%] top-[-28px] flex flex-col items-center">
          <div className="text-xs mt-1 text-white-300">NOVEMBER 21,2025</div>
          <div className="pt-2">
            <div className="w-2.5 h-2.5 bg-white rounded-full border-2 border-white -mt-[2px]"></div>
          </div>
          ...
          <div className="text-center">
            ...
            <div className="text-sm">SUBMISSION  [10:00 A.M.]</div>
          </div>
        </div>
        ...
        <div className="absolute left-[95%] top-[-209px] flex flex-col items-center">
          ...
          <div className="w-0 h-30 border-dashed border-l-2 border-white"></div>
          <div className="w-2.5 h-2.5 bg-white rounded-full border-2 border-white -mt-[2px]"></div>
          <div className="text-xs mt-2 text-white-300">NOVEMBER 21,2025  [2:00 P.M.] </div>
        </div>
      </div>
    </div>
  );
