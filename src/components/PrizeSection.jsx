...
const PrizeSection = () => {
    ...
    return (
        <section className="text-center py-16">
            <h1 className="text-5xl font-bold font-[Inter] pb-7">PRIZES</h1>
            <p className="text-black font-[Inter] text-m mb-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-y-10 gap-x-8 justify-items-center max-w-5xl mx-auto">
                ...
                <div className="flex flex-col md:flex-row md:col-span-3 justify-center gap-100">
